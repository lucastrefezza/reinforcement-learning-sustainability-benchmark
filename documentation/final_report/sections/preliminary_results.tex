...
%(human and min--max normalized) and per-game mean emissions. Table~\ref{tab:per_game_example}
...
%We also provide environment-specific line plots of episodic returns (Figures~\ref{fig:alien_comparison_combined}-\ref{fig:pong_comparison_combined})
%for readers who wish to explore how training evolves in detail, commented in the next section.
%
