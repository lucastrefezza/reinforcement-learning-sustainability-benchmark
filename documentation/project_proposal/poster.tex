...
% this states the box starts at column 0 (edge of page), directly below the box labelled idea for a span of 2 (column wide)
...
\vspace{0.7cm} %remove this, only added for spacing
}
...
\headerbox{Award Criteria}{name=awcriteria,column=2,below=startingasset,span=1,above=bottom}{
  \vspace{0.3cm}
